...
int main() {
  ...
  if (com == "intersection") print_set(intersection(A, B));
  else if (com == "union_set") print_set(union_set(A, B));
  else if (com == "symmetric_diff") print_set(symmetric_diff(A, B));
  else if (com == "subtract") {
    int x; cin >> x;
    print_set(subtract(A, x));
  }
  else if (com == "increment") print_set(increment(A));
  else if (com == "decrement") print_set(decrement(A));
}
