...
int main() {
  ...
  bool ans = false;
  if ((A == 1 || A == 3) && B == 2) ans = true;
  else if (A == 2 && (B == 1 || B == 3)) ans = true;
  else if ((A == 4 || A == 6) && B == 5) ans = true;
  else if (A == 5 && (B == 4 || B == 6)) ans = true;
  else if ((A == 7 || A == 9) && B == 8) ans = true;
  else if (A == 8 && (B == 7 || B == 9)) ans = true;
